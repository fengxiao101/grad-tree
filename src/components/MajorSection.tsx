...
import {
  ...
  Info, X, BookMarked, Layers, Loader2, ExternalLink,
} from 'lucide-react';
...
import { SlotRow } from './major/SlotRow';
...
import type { MajorConfig, MajorSection as MajorSectionType, MetaRequirement, Track } from '../data/majorSchema';
import {
  type Affiliation,
  type CourseCard,
