# Stanford Course Planner - CLAUDE.md
...
1. **`course_sheets/encoding-mistakes.md`** - all known pitfalls from prior encodings
...
**Always read `course_sheets/encoding-mistakes.md` first, regardless of mode.**
...
Mistake log: `course_sheets/encoding-mistakes.md` - read before every extraction.
